...
python3 txt2vid/train/gan.py --data $VIDEO_DIR --anno $ANNO --workers 4 --batch_size 32 --epochs 100 --out $OUT_DIR --out_samples $EXAMPLE_DIR --num_channels 3 --vocab $VOCAB --cuda --G txt2vid.models.tcwyt.gen.Gen --D txt2vid.models.tcwyt.video_discrim.VideoDiscrim txt2vid.models.tcwyt.frame_discrim.FrameDiscrim txt2vid.models.tcwyt.motion_discrim.MotionDiscrim --sent txt2vid.models.txt.basic.Seq2Seq --sent_weights msr/sent.pth --frame_size 48 --M txt2vid.models.tcwyt.frame_discrim.FrameMap --D_names video frame motion
