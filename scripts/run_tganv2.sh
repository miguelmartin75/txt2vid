...
OUT_NAME=${OUT_NAME:-output_tganv2_uncond}
...
python3 txt2vid/train/gan.py --data ./config/mrvdc.json --workers 8 --batch_size 20 --epochs 100 --out $OUT_DIR --out_samples $EXAMPLE_DIR --num_channels 3 --vocab $VOCAB --cuda --G txt2vid.models.tganv2.gen.MultiScaleGen --D txt2vid.models.tganv2.discrim.MultiScaleDiscrim --sent txt2vid.models.txt.basic.Seq2Seq --sent_weights msr/sent.pth --frame_sizes 24 48 96 192 --D_names video --G_lr 0.0001 --D_lr 0.0001 --D_beta1 0.0 --D_beta2 .9 --G_beta1 0.0 --G_beta2 .9 --D_loss txt2vid.gan.losses.WassersteinGanLoss --init_method xavier --discrim_steps 1 --dont_use_sent --seed 1 --gp_lambda .5 --no_mean_discrim_loss --log_period 10 --save_example_period 50 --loss_window_size 20 --use_writer --anno $ANNO --subsample_input --sample_batch_size 20
#python3 txt2vid/train/gan.py --data ./config/mrvdc.json --workers 8 --batch_size 64 --epochs 100 --out $OUT_DIR --out_samples $EXAMPLE_DIR --num_channels 3 --vocab $VOCAB --cuda --G txt2vid.models.tganv2.gen.MultiScaleGen --D txt2vid.models.tgan.discrim.Discrim --sent txt2vid.models.txt.basic.Seq2Seq --sent_weights msr/sent.pth --frame_sizes 8 16 32 64 --D_names video --G_lr 0.0001 --D_lr 0.0001 --D_beta1 0.0 --D_beta2 .9 --G_beta1 0.0 --G_beta2 .9 --D_loss txt2vid.gan.losses.WassersteinGanLoss --init_method xavier --discrim_steps 5 --dont_use_sent --seed 1 --gp_lambda -.5 --no_mean_discrim_loss --log_period 10 --save_example_period 10 --loss_window_size 10 --use_writer --anno $ANNO --subsample_input --sample_batch_size 20
