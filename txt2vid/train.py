...
def main(args):
    ...
    def gen_step(nsteps=1, fake=None, fake_frames=None, cap_fv=None, real_labels=None, real_labels_frames=None, last=True, real_videos=None):
        ...
        loss_d0 = criteria(real_vids, real_labels)
        loss_d1 = criteria(real_frames, real_labels_frames)
        loss_d2 = criteria(real_motion, real_labels_motion)
    ...
    def discrim_step(nsteps=1, videos=None, cap_fv=None, real_labels=None, fake_labels=None, real_labels_frames=None, fake_labels_frames=None, last=True, fake=None, device=None):
        ...
        loss_d0 = discrim_forward(discrim=discrim, real_x=videos.detach(), fake_x=fake.detach(), correct_captions=cap_fv, incorrect_captions=incorrect_captions, device=device, real_labels=real_labels, fake_labels=fake_labels)
        loss_d1 = discrim_forward(discrim=frame_discrim, real_x=frames, fake_x=fake_frames, correct_captions=cap_fv, incorrect_captions=incorrect_captions, device=device, real_labels=real_labels_frames, fake_labels=fake_labels_frames)
        loss_d2 = discrim_forward(discrim=motion_discrim, real_x=frames, fake_x=fake_frames, correct_captions=cap_fv, incorrect_captions=incorrect_captions, device=device, real_labels=real_labels_motion, fake_labels=fake_labels_motion)
